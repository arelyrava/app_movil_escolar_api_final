...
class AlumnosView(generics.CreateAPIView):
    ...
    def put(self, request, *args, **kwargs):
        # El permiso se maneja en get_permissions()
        
        # Obtenemos el alumno a actualizar
    ...
    def delete(self, request, *args, **kwargs):
            # 1. Obtener el objeto Alumnos a eliminar usando el ID del query parameter
            alumno = get_object_or_404(Alumnos, id=request.GET.get("id"))
            ...
            try:
                ...
                return Response({"details":"Algo pasó al intentar eliminar el alumno"},400)