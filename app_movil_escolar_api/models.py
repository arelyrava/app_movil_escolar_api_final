...
class Evento(models.Model):
    ...
    responsable = models.ForeignKey(User, on_delete=models.CASCADE, related_name='eventos_a_cargo', null=False, blank=False)
    
    nombre = models.CharField(max_length=255, null=False, blank=False)
    tipo = models.CharField(max_length=50, choices=TIPOS_EVENTO, null=False, blank=False)
    ...
    # Se guarda como texto separado por comas: "Estudiantes,Profesores"
    ...
    cupo = models.PositiveIntegerField(null=False, blank=False)
